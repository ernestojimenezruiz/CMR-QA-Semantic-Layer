...
## Test data
We provide a sample of the data to use to run the scripts in this repo. The data is synthetic, it has been generated by randomising, anonymysing the original quality annotations that were used for the publications provided in docs.
Each entry in the csv file represents the MRI scan of a fictitious volunteer and is described by
- identifier (Source _ID)
- date in which the MRI scan took place (Scan_Date)
- the quality of the cardiac MRI scan is described by a comment (Free text comment)
- LVQC - left ventricle quality code
- RVQC - right ventricle quality code
- LAQC - left atrium quality code
- RAQC - right atrium quality code

For further description of the data, please refer to the publications linked further below
